...
func NewAppsController(service *goa.Service, config *configuration.Registry) *AppsController {
	return createAppsController(AppsControllerConfig{}, service, config)
}

func createAppsController(appConfig AppsControllerConfig, service *goa.Service, registryConfig *configuration.Registry)*AppsController {
