...
func (k kubeClientResourceProviderMock) GetResource(url string, allowMissing bool) (map[interface{}]interface{}, error) {
	return k.resourceMap, nil
}

func (k kubeClientResourceProviderMock) GetClusterURL() string {
	return ""
}

func (k kubeClientResourceProviderMock) GetBearerToken() string {
	return ""
}
...
func TestGetBestRoute(t *testing.T) {
	...
	var resourceProvider KubeClientResourceProvider = kubeClientResourceProviderMock{
		resourceMap: map[interface{}]interface{}{
			"kind":  "RouteList",
			"items": mockRouteMap,
		},
	...
	kubeClient := kubeClient{
		...
		KubeClientResourceProvider: resourceProvider,
	}
